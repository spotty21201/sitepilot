...
describe('Google GenAI & Vertex AI Integration Suite', () => {
  ...
  it('configures Vertex AI with the release model gemini-3.7-flash when GOOGLE_CLOUD_PROJECT is set', () => {
  ...
  it('defaults to the release Gemini 3.7 Flash model when GEMINI_MODEL is not explicitly set', () => {
